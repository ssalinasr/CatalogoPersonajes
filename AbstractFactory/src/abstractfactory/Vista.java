...
/*
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblCuerpo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 250, 190));
        jPanel1.add(lblArma, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 70, 210, 190));
        jPanel1.add(lblEscudo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 70, 210, 190));

        lblCDes.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lblCDes, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 270, 40));

        lblADes.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lblADes, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 270, 230, 40));

        lblEDes.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lblEDes, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 270, 230, 40));
...
*/
    ...
    private void initComponents(){
        ...
        this.lblCDes.setForeground(Color.white);
        this.lblEDes.setForeground(Color.white);
        this.lblADes.setForeground(Color.white);
        
        this.lblCDes.setFont(new Font("Tahoma",Font.PLAIN,9));
        this.lblEDes.setFont(new Font("Tahoma",Font.PLAIN,9));
        this.lblADes.setFont(new Font("Tahoma",Font.PLAIN,9));
